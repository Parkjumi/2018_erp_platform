...
export default{
    ...
    methods: {
        // ===== 저장 ===== //
        updateNotice(){
          this.$axios.put('http://freshntech.cafe24.com/cuboarders/'+notice_id,{
          ...
          .then(res => {
            alert('수정되었습니다.')
            this.$router.push('/notice/customer/list')
          })
          .catch((ex) => {
            console.log("Error : ",ex);
          })
        ...
        deleteNotice(){
          this.$axios.delete('http://freshntech.cafe24.com/cuboarders/'+notice_id)
          .then(res => {
            alert('삭제가 완료되었습니다.');
            this.$router.push('/notice/customer/list');
          })
